// A fake downstream MCP server for the router self-checks: two tools, served over two pages.
...
lines(process.stdin, m => {
  ...
  if (m.method === "tools/call") {
    ...
    if (m.params.name === "echo") return r({content: [{type: "text", text: `echo: ${a.text}`}]});
